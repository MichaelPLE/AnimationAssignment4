		...
		namespace glfw
		{
			...
			public:
			   ...
			   // IGL_INLINE void draw();
				...
				bool ifCollide(ViewerData& data1, ViewerData& data2);
				bool ifCollide(ViewerData& data1, ViewerData& data2, Eigen::Matrix4f trans1, igl::AABB<Eigen::MatrixXd, 3>* tree1, Eigen::Matrix4f trans2, igl::AABB<Eigen::MatrixXd, 3>* tree2);
				bool ifCollide(Eigen::AlignedBox<double, 3> box1, Eigen::AlignedBox<double, 3> box2, Eigen::Matrix4f trans1, Eigen::Matrix4f trans2);
