    ...
    const Eigen::MatrixXd& _V, const Eigen::MatrixXi& _F)
{
  ...
  tree.init(V, F);
  auto color = Eigen::RowVector3d(0, 1, 0);
  rec_tree_boxes(&tree,Eigen::RowVector3d::Random(3).normalized(),1);
  line_width = 2;
...
int i = 0;
void igl::opengl::ViewerData::rec_tree_boxes(igl::AABB < Eigen::MatrixXd, 3>* tree, Eigen::RowVector3d color,int lvlsToDraw) {
    Eigen::AlignedBox<double, 3> box(tree->m_box);
    //VectorType a = box.corner(box.BottomLeftCeil);
    if (lvlsToDraw == 0) return;
    
    //front
    add_edges
    (
        Eigen::RowVector3d(box.corner(box.BottomLeftCeil)(0), box.corner(box.BottomLeftCeil)(1), box.corner(box.BottomLeftCeil)(2)),
        Eigen::RowVector3d(box.corner(box.BottomRightCeil)(0), box.corner(box.BottomRightCeil)(1), box.corner(box.BottomRightCeil)(2)),
        color
    );
    add_edges
    (
        Eigen::RowVector3d(box.corner(box.TopRightCeil)(0), box.corner(box.TopRightCeil)(1), box.corner(box.TopRightCeil)(2)),
        Eigen::RowVector3d(box.corner(box.BottomRightCeil)(0), box.corner(box.BottomRightCeil)(1), box.corner(box.BottomRightCeil)(2)),
        color
    );
    add_edges
    (
        Eigen::RowVector3d(box.corner(box.TopRightCeil)(0), box.corner(box.TopRightCeil)(1), box.corner(box.TopRightCeil)(2)),
        Eigen::RowVector3d(box.corner(box.TopLeftCeil)(0), box.corner(box.TopLeftCeil)(1), box.corner(box.TopLeftCeil)(2)),
       color
    );
    add_edges
    (
    ...
    add_edges
    (
        Eigen::RowVector3d(box.corner(box.BottomLeftFloor)(0), box.corner(box.BottomLeftFloor)(1), box.corner(box.BottomLeftFloor)(2)),
        Eigen::RowVector3d(box.corner(box.BottomRightFloor)(0), box.corner(box.BottomRightFloor)(1), box.corner(box.BottomRightFloor)(2)),
        color
    );
    add_edges
    (
        Eigen::RowVector3d(box.corner(box.TopRightFloor)(0), box.corner(box.TopRightFloor)(1), box.corner(box.TopRightFloor)(2)),
        Eigen::RowVector3d(box.corner(box.BottomRightFloor)(0), box.corner(box.BottomRightFloor)(1), box.corner(box.BottomRightFloor)(2)),
        color
    );
    add_edges
    (
        Eigen::RowVector3d(box.corner(box.TopRightFloor)(0), box.corner(box.TopRightFloor)(1), box.corner(box.TopRightFloor)(2)),
        Eigen::RowVector3d(box.corner(box.TopLeftFloor)(0), box.corner(box.TopLeftFloor)(1), box.corner(box.TopLeftFloor)(2)),
        color
    );
    add_edges
    (
    ...
    if (tree->m_left != nullptr)
        rec_tree_boxes(tree->m_left, Eigen::RowVector3d::Random(3).normalized(), --lvlsToDraw);
    if (tree->m_right != nullptr)
        rec_tree_boxes(tree->m_right, Eigen::RowVector3d::Random(3).normalized(), lvlsToDraw);
